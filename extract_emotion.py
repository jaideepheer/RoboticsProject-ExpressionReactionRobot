...
class emotion_extractor_sarengil:
    def __init__(self, kerasModelPath="facial_expression_model_structure.json", kerasModelWeightsPath="facial_expression_model_weights.h5"):
    ...
    def getFaceEmotion(self, imageData):
        # pre-processing
...
class emotion_extractor_oarriaga:
    def __init__(self, kerasModelPath="fer2013_mini_XCEPTION.102-0.66.hdf5"):
