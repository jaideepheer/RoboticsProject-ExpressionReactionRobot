import cv2
import numpy as np
class face_extractor_cascade:
    def __init__(self, cascadeXMLFilePath='haarcascade_frontalface_default.xml'):
...
class face_extractor_dnn:
    def __init__(self, dnnModelFile="res10_300x300_ssd_iter_140000_fp16.caffemodel", dnnConfigFile="deploy.prototxt", confidenceThreshold = .6, ignoreOutOfBoundDetections=True):
        # check files
